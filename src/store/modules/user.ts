...
import { GetUserInfoModel, LoginParams } from '../../api/sys/model/authModel';
import { doLogout, getUserInfo, doLogin } from '../../api/sys/auth';
  ...
  actions: {
    ...
    async login(
      ...
      try {
        ...
        const data = await doLogin(loginParams, mode);
